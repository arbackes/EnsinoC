...
const Aula06_02 = () => {
  return (
    <Page nextRoute='Menu'>
        ...
        <Text style={{ color: '#008800', fontStyle: 'italic'}}>//protótipo da função</Text>
        <Text><Text style={{ color: '#000080', fontWeight: 'bold' }}>int</Text> fatorial(<Text style={{ color: '#000080', fontWeight: 'bold' }}>int</Text> N);{'\n'}</Text>
